...
from src.utils.util import load_numpy_array_data,save_object,load_object
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self)->ModelTrainerArtifact:
        try:
            ...
            logging.info(f"overfit score: {overfit_score}")
            ...
            banking_model = BankingPredictorModel(preprocessing_object=preprocessing_obj,trained_model_object=model_obj)
